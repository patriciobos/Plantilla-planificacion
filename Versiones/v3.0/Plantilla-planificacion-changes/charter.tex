...
\fechaFINALPlan{9 de diciembre de 2023} 	%Fecha de final de cursada de GdP
\fechaFINALTrabajo{16 de diciembre de 2023}	%Fecha de defensa pública del trabajo final
...
2      & Se completa hasta el punto 8 inclusive                 & 10/11/2022 \\ \hline
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en {la implementación de un prototipo de un sistema de control de empleados}, y tendrá un presupuesto preliminar estimado de {600} hs de trabajo y \textcolor{red}{\$Presupuesto por definir}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
Debido a la incursión de medios Smartphone, dispositivos electrónicos que se conectan a través de internet, es necesario dar una solución más sencilla para el proceso de registro de entrada y salida del personal que labora en el interior de la empresa. ``En la Figura \ref{fig:diagBloques} se presenta el diagrama en bloques del sistema. Se observa que desde el dispositivo se hace el registro, este se procesa, valida, asigna de forma interna para luego enviar la notificación respectiva a quien corresponda.
...
Impulsor      & Ing. Juan Carlos       &\empclientename	& Supervisor\\ \hline
Responsable   & \authorname       & FIUBA        	& Alumno 	\\ \hline
Colaboradores & Ing. Alejandro Montero &\empclientename 	& Producción\\ \hline
Orientador    & \supname	      & \pertesupname 	& Director Trabajo final \\ \hline
Equipo        & Ing. Juan Carlos \newline 
				Ing. Alejandro Montero & \empclientename	& Empleados \\ \hline
Opositores    &        -          &       -      	&    -   	\\ \hline
Usuario final &        -          &       -      	&    -   	\\ \hline
\end{tabularx}
\end{table}
...
tiempo, duración y salida de un empleado en la empresa \empclientename, con el uso de la metodología SCRUM.
...
\begin{itemize}
	\item La disponibilidad del cliente Ing. \clientename, las personas encargadas para la guía en el avance del proyecto. 
...
\begin{enumerate}
	\item Requerimientos funcionales
		\begin{enumerate}
			\item El sistema debe autenticar solo a los usuarios registrados.
			...
			\item El supervisor y usuario pueden ver el tiempo de estancia en la empresa.
			\item El usuario puede darse de alta en la salida de la empresa.
			\item El supervisor y empleado reciben una notificación push de ingreso a la empresa.
			\item El supervisor y usuario reciben una notificación push de salida de la empresa.
			\item Cada empleado tiene un registro de entradas, salidas con tiempos de estancia que se pueden ver a través de grafos.
			\item El empleado puede el tiempo de estancia total a través durante el tiempo que empezó el registro en el sistema.
		\end{enumerate}
