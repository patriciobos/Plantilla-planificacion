...
\node (tarea1) [task, below of=inicio, xshift=2cm] {Tarea 1};
\node (tarea2) [task, right of=tarea1, xshift=2cm] {Tarea 2};
\node (tarea3) [task, right of=tarea2, xshift=2cm] {Tarea 3};
%\node (fin) [milestone, right of=tarea3] {Fin};
