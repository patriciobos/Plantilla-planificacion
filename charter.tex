...
Para desarrollar el Gantt se utilizó la herramienta Trello con el plugin BigPicture. La herramienta no tiene una opción para exportar, por lo que se agregan capturas del diagrama.
...
\caption{Diagrama de \textit{Gantt parte 1/8}}
\label{fig:Gantt1}
\end{figure}
...
\caption{Diagrama de \textit{Gantt parte 2/8}}
\label{fig:Gantt2}
\end{figure}
...
\caption{Diagrama de \textit{Gantt parte 3/8}}
\label{fig:Gantt3}
\end{figure}
...
\caption{Diagrama de \textit{Gantt parte 4/8}}
\label{fig:Gantt4}
\end{figure}
...
\caption{Diagrama de \textit{Gantt parte 5/8}}
\label{fig:Gantt5}
\end{figure}
...
\caption{Diagrama de \textit{Gantt parte 6/8}}
\label{fig:Gantt6}
\end{figure}
...
\caption{Diagrama de \textit{Gantt parte 7/8}}
\label{fig:Gantt7}
\end{figure}

\begin{figure}[htpb]
\centering 
\includegraphics[width=.999\textwidth]{./Figuras/Gantt-8.png}
\caption{Diagrama de \textit{Gantt parte 8/8}}
\label{fig:Gantt8}
\end{figure}
