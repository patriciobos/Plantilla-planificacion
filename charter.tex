...
\juradoUNO{Nombre y Apellido (1) (pertenencia)} 
\juradoDOS{Nombre y Apellido (2) (pertenencia)}
\juradoTRES{Nombre y Apellido (3) (pertenencia)}
...
\textcolor{red}{Utilizar el software Gantter for Google Drive o alguno similar para dibujar el diagrama de Gantt.}

\textcolor{red}{Pegar acá una captura de pantalla del diagrama de Gantt, cuidando que la letra sea suficientemente grande como para ser legible. Pegar primero la “tabla” del Gantt y luego pegar la parte del diagrama de barras del diagrama de Gantt.}

\textcolor{red}{Configurar el software para que en la parte de la tabla muestre los códigos del EDT (WBS).\\
Configurar el software para que al lado de cada barra muestre el nombre de cada tarea.\\
Revisar que la fecha de finalización coincida con lo indicado en el Acta Constitutiva.}

\textcolor{red}{Se puede usar paquete de latex pgfgantt para hacer el diagrama.}
