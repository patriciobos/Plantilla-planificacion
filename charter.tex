...
\newline Priorización: se puntúa una prioridad del 1 (alta) al 5 (baja).

\begin{itemize}
	\item Como usuario general del sistema quiero loguearme al sistema usando mail y contraseña.
	\newline Ponderación: 2
	\newline Priorización: 2
	\item Como usuario general del sistema quiero desloguearme del sistema.
	...
	\item Como administrador del sistema quiero dar de alta usuarios de tipo responsable y visitante.
	\newline Ponderación: 2
	\newline Priorización: 2
	\item Como administrador del sistema quiero modificar o eliminar usuarios de tipo responsable y visitante.
	\newline Ponderación: 2
	\newline Priorización: 2
	\item Como administrador del sistema quiero dar de alta una huerta en el sistema y asociarla a un responsable.
	\newline Ponderación: 5
	\newline Priorización: 1
	\item Como administrador del sistema quiero modificar y eliminar cualquier huerta del sistema.
	\newline Ponderación: 3
	\newline Priorización: 2	
	\item Como administrador del sistema quiero asociar un sector de una huerta a un dispositivo usando su código único.
	\newline Ponderación: 3
	\newline Priorización: 1
	\item Como administrador del sistema quiero administrar los porcentajes de aceptación de humedad por sector en cualquier huerta.
	\newline Ponderación: 3
	\newline Priorización: 1
	\item Como administrador del sistema ver y modificar los datos básicos de los roles del sistema.
	\newline Ponderación: 2
	\newline Priorización: 3
	\item Como administrador del sistema quiero visualizar las mediciones de un sector de cualquier huerta
	\newline Ponderación: 5
	\newline Priorización: 2
	
	\item Como responsable de una huerta quiero darme de alta en el sistema con mail y password.
	\newline Ponderación: 2
	\newline Priorización: 1
	\item Como responsable de una huerta quiero dar de alta una huerta y que se asocie a mi usuario.
	\newline Ponderación: 3
	\newline Priorización: 1
	\item Como responsable de una huerta quiero ver, modificar y eliminar mis huertas asociadas.
	\newline Ponderación: 3
	\newline Priorización: 2
	\item Como responsable de una huerta quiero asociar un sector de una huerta mía a un dispositivo usando su código único.
	\newline Ponderación: 1
	\newline Priorización: 1
	\item Como responsable de una huerta quiero administrar los porcentajes de aceptación de humedad por sector en mis huertas.
	\newline Ponderación: 1
	\newline Priorización: 1
	\item Como responsable de una huerta quiero visualizar las mediciones de un sector de cualquiera de mis huertas.
	\newline Ponderación: 1
	\newline Priorización: 1
	\item Como responsable de una huerta quiero crear usuarios con rol visitante y asociarlos a cualquiera de mis huertas
	\newline Ponderación: 2
	\newline Priorización: 3
	
	\item Como usuario visitante de una huerta quiero visualizar las huertas a las que estoy asociado.
	\newline Ponderación: 1
	\newline Priorización: 1
	\item Como usuario visitante de una huerta quiero visualizar las métricas de un sector de cualquiera de las huertas a las que estoy asociado.
	\newline Ponderación: 1
	\newline Priorización: 1
\end{itemize}
...
\item Desarrollo del back-end del software (215 hs)
	...
	\item Desarrollo de gestión de usuarios y roles (40 hs)
	\item Desarrollo de gestión permisos (20 hs)
	\item Desarrollo de secciones de alta, baja y modificación de huertas (60 hs)
	\item Desarrollo de sección de administración de una huerta (20 hs)
	\item Desarrollo de visualización de métricas (20 hs)
	\item Desarrollo de integración con dispositivos (40 hs)
	\end{enumerate}
	
\item Desarrollo del front-end del software (255 hs)
	\begin{enumerate}
	\item Maquetado de vistas con la definición de estilos y colores (40 hs)
	\item Desarrollo a arquitectura base del front-end (15 hs)
	\item Desarrollo de vista gestión de usuarios y roles (40 hs)
	\item Desarrollo de vistas de alta, baja y modificación de huertas (60 hs)
	\item Desarrollo de vistas de administración de una huerta (20 hs)
	\item Desarrollo de vista para visualización de métricas (80 hs)
	\end{enumerate}
\end{enumerate}

Cantidad total de horas: (685 hs)
