...
% Tu nombre, se puede usar el cualquier lugar del documento con el comando \autor
...
\codirector{Título y Nombre del codirector} % para que aparezca en la portada se debe descomentar la opción codirector en el documentclass
